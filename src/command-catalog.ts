...
export const SLASH_COMMANDS: readonly SlashCommand[] = [
  ...
  { path: "/cloud", description: "Switch to the managed cloud workflow." },
  { path: "/local", description: "Switch to the local GPU workflow." },
  { path: "/mode cloud", description: "Alias for /cloud." },
  { path: "/mode local", description: "Alias for /local." },
